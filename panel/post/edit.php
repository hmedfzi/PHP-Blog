    ...
    {      
        ...
        if(isset($_FILES['image']) && $_FILES['image']['name'] !== "" ){
            ...
            if($category !== false && $image_upload !== false)
            {
                ...
                $statement = $pdo->prepare($query);
                $statement->execute([$_POST['title'], $_POST['cat_id'], $_POST['body'], $image, $post->id]);
        ...
        if($category !== false )
        {
            ...
            $statement = $pdo->prepare($query);
            $statement->execute([$_POST['title'], $_POST['cat_id'], $_POST['body'], $post->id]);
                ...
                <section class="col-md-10 pt-3">
                    ...
                    <form action="<?= url('panel/post/edit.php?post_id='. $post->id) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <section class="form-group">
                            ...
                            <img src="<?= asset($post->image) ?>" alt="" height="200px" width="200px">
                        </section>
                        <?php
                        global $pdo;
